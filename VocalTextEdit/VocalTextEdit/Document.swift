...
class Document: NSDocument {
    ...
    override func dataOfType(typeName: String) throws -> NSData {
        ...
        if let data = contents.dataUsingEncoding(NSUTF8StringEncoding) {
            ...
            throw NSError(domain: "com.bignerdrand.VocalTextEdit", code: 0, userInfo: userInfo)
        }
    ...
    override func readFromData(data: NSData, ofType typeName: String) throws {
        if let contents = NSString(data: data, encoding: NSUTF8StringEncoding) as? String {
            ...
            throw NSError(domain: "com.ignerdranch.VocalTextEdit", code: 0, userInfo: userInfo)
        }
    }
}
